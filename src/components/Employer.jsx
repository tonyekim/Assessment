...
const Employer = () => {
  ...
  const handleButtonClick = () => {
    window.open(
      "https://help.optimism.io/hc/en-us/articles/4411903123483-Connecting-your-wallet-to-Optimism",
      "_blank"
    );
  };
        ...
        <div className="ml-10 mt-2 flex flex-col gap-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className="bg-black text-white rounded-xl font-bold text-lg"
            >
              <div>
                <div className="walletCard">
                  <button onClick={connectWalletHandler}>
                    <h4> Click to Connect Metamask </h4>
                  </button>
                </div>
              </div>
            </button>
          ...
          <div className="">
            <div className="accountDisplay">
              <h3 className="font-bold">{defaultAccount}</h3>
            </div>
          ...
          <div className="border border-gray-200 h-[220px] w-[450px] rounded flex flex-col gap-8 py-8">
            ...
            <div className="flex gap-3 items-center justify-center">
              <button className="text-xl">JobSeeker Dashboard</button>
            </div>
          </div>
        </div>
      </div>
